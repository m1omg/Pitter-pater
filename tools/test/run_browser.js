...
(async () => {
  ...
  const browser = await puppeteer.launch({
    executablePath: process.env.BROWSER || "/usr/bin/google-chrome",
    headless: 'new',
    args: ["--user-data-dir=/tmp/claude-1000/viv-profile", '--autoplay-policy=no-user-gesture-required', '--window-size=960,720'],
  });
